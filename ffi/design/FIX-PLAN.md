...
| R-H27 | U-* rows differ: C++ has no encode direction; Python and Java use the corpus-schema core; Java has no `accept` filter; counts 92 or 311 | CP4 || owner 2026-09-26: accepted shapes-root rows, 3 directions, timed shapes core (req 7) |
