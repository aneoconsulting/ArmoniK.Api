...
struct ak_dec_ResultRaw_opts {
  ...
  struct ak_unk_opts completed_at;  /* Timestamp */
};
...
struct ak_dec_TaskDetailed_opts {
  ...
  struct ak_unk_opts started_at;  /* Timestamp */
  struct ak_unk_opts ended_at;  /* Timestamp */
  struct ak_unk_opts pod_ttl;  /* Timestamp */
  struct ak_unk_opts output;  /* TaskOutput */
  struct ak_unk_opts received_at;  /* Timestamp */
  struct ak_unk_opts acquired_at;  /* Timestamp */
  struct ak_unk_opts creation_to_end_duration;  /* Duration */
  struct ak_unk_opts processing_to_end_duration;  /* Duration */
  struct ak_unk_opts received_to_end_duration;  /* Duration */
  struct ak_unk_opts processed_at;  /* Timestamp */
  struct ak_unk_opts fetched_at;  /* Timestamp */
};
...
struct ak_dec_LeafElement_opts {
  ...
  struct ak_unk_opts stamp;  /* Timestamp */
};
...
struct ak_dec_WireZoo_opts {
  ...
  struct ak_unk_opts v_msg;  /* Timestamp */
};
#define AK_DEC_WIREZOO_OPTS_N 2
...
AK_SASSERT(offsetof(struct ak_dfix_ChunkElement, unknown) == 40, "ak_dfix_ChunkElement.unknown");
AK_SASSERT(offsetof(struct ak_dfix_ChunkElement, presence) == 56, "ak_dfix_ChunkElement.presence");
AK_SASSERT(sizeof(struct ak_dfix_ChunkElementAttrsEntry) == 48, "sizeof ak_dfix_ChunkElementAttrsEntry");
...
AK_SASSERT(offsetof(struct ak_dfix_ChunkElementAttrsEntry, unknown) == 24, "ak_dfix_ChunkElementAttrsEntry.unknown");
AK_SASSERT(offsetof(struct ak_dfix_ChunkElementAttrsEntry, presence) == 40, "ak_dfix_ChunkElementAttrsEntry.presence");
AK_SASSERT(sizeof(struct ak_dfix_ChunkInner) == 24, "sizeof ak_dfix_ChunkInner");
AK_SASSERT(offsetof(struct ak_dfix_ChunkInner, unknown) == 0, "ak_dfix_ChunkInner.unknown");
AK_SASSERT(offsetof(struct ak_dfix_ChunkInner, presence) == 16, "ak_dfix_ChunkInner.presence");
AK_SASSERT(sizeof(struct ak_dfix_ChunkLeaf) == 40, "sizeof ak_dfix_ChunkLeaf");
...
AK_SASSERT(offsetof(struct ak_dfix_ChunkLeaf, unknown) == 16, "ak_dfix_ChunkLeaf.unknown");
AK_SASSERT(offsetof(struct ak_dfix_ChunkLeaf, presence) == 32, "ak_dfix_ChunkLeaf.presence");
AK_SASSERT(sizeof(struct ak_dfix_ChunkedResponse) == 32, "sizeof ak_dfix_ChunkedResponse");
AK_SASSERT(offsetof(struct ak_dfix_ChunkedResponse, page) == 0, "ak_dfix_ChunkedResponse.page");
AK_SASSERT(offsetof(struct ak_dfix_ChunkedResponse, unknown) == 8, "ak_dfix_ChunkedResponse.unknown");
AK_SASSERT(offsetof(struct ak_dfix_ChunkedResponse, presence) == 24, "ak_dfix_ChunkedResponse.presence");
AK_SASSERT(sizeof(struct ak_dfix_ChunkedResponseWide) == 24, "sizeof ak_dfix_ChunkedResponseWide");
AK_SASSERT(offsetof(struct ak_dfix_ChunkedResponseWide, unknown) == 0, "ak_dfix_ChunkedResponseWide.unknown");
AK_SASSERT(offsetof(struct ak_dfix_ChunkedResponseWide, presence) == 16, "ak_dfix_ChunkedResponseWide.presence");
...
AK_SASSERT(sizeof(struct ak_dfix_LeafElement) == 88, "sizeof ak_dfix_LeafElement");
...
AK_SASSERT(offsetof(struct ak_dfix_LeafElement, unknown) == 64, "ak_dfix_LeafElement.unknown");
AK_SASSERT(offsetof(struct ak_dfix_LeafElement, presence) == 80, "ak_dfix_LeafElement.presence");
AK_SASSERT(sizeof(struct ak_dfix_LeafResponse) == 24, "sizeof ak_dfix_LeafResponse");
AK_SASSERT(offsetof(struct ak_dfix_LeafResponse, unknown) == 0, "ak_dfix_LeafResponse.unknown");
AK_SASSERT(offsetof(struct ak_dfix_LeafResponse, presence) == 16, "ak_dfix_LeafResponse.presence");
...
AK_SASSERT(sizeof(struct ak_dfix_Surrogate) == 96, "sizeof ak_dfix_Surrogate");
AK_SASSERT(offsetof(struct ak_dfix_Surrogate, text) == 0, "ak_dfix_Surrogate.text");
AK_SASSERT(offsetof(struct ak_dfix_Surrogate, nested) == 16, "ak_dfix_Surrogate.nested");
AK_SASSERT(offsetof(struct ak_dfix_Surrogate, raw) == 56, "ak_dfix_Surrogate.raw");
AK_SASSERT(offsetof(struct ak_dfix_Surrogate, unknown) == 72, "ak_dfix_Surrogate.unknown");
AK_SASSERT(offsetof(struct ak_dfix_Surrogate, presence) == 88, "ak_dfix_Surrogate.presence");
AK_SASSERT(sizeof(struct ak_dfix_SurrogateAttrsEntry) == 48, "sizeof ak_dfix_SurrogateAttrsEntry");
...
AK_SASSERT(offsetof(struct ak_dfix_SurrogateAttrsEntry, unknown) == 24, "ak_dfix_SurrogateAttrsEntry.unknown");
AK_SASSERT(offsetof(struct ak_dfix_SurrogateAttrsEntry, presence) == 40, "ak_dfix_SurrogateAttrsEntry.presence");
AK_SASSERT(sizeof(struct ak_dfix_SurrogateInner) == 40, "sizeof ak_dfix_SurrogateInner");
AK_SASSERT(offsetof(struct ak_dfix_SurrogateInner, text) == 0, "ak_dfix_SurrogateInner.text");
AK_SASSERT(offsetof(struct ak_dfix_SurrogateInner, unknown) == 16, "ak_dfix_SurrogateInner.unknown");
AK_SASSERT(offsetof(struct ak_dfix_SurrogateInner, presence) == 32, "ak_dfix_SurrogateInner.presence");
...
AK_SASSERT(sizeof(struct ak_dfix_WireZoo) == 136, "sizeof ak_dfix_WireZoo");
...
AK_SASSERT(offsetof(struct ak_dfix_WireZoo, v_big_tag) == 104, "ak_dfix_WireZoo.v_big_tag");
AK_SASSERT(offsetof(struct ak_dfix_WireZoo, unknown) == 112, "ak_dfix_WireZoo.unknown");
AK_SASSERT(offsetof(struct ak_dfix_WireZoo, presence) == 128, "ak_dfix_WireZoo.presence");
