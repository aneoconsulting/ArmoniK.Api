...
public final class Binding implements AutoCloseable, ak.Callbacks {
  ...
  long decCtxOf(int ri) {
    ...
    if (c != 0) return c;
    switch (ri) {
      case 0: c = ak.NativeEntry.decCtxNewListResultsResponse(); break;
      case 1: c = ak.NativeEntry.decCtxNewListTasksDetailedResponse(); break;
      case 2: c = ak.NativeEntry.decCtxNewListProbeResponse(); break;
      case 3: c = ak.NativeEntry.decCtxNewListTaskSummaryResponse(); break;
      case 4: c = ak.NativeEntry.decCtxNewUploadResultDataMessage(); break;
      case 5: c = ak.NativeEntry.decCtxNewListMetricsResponse(); break;
      case 6: c = ak.NativeEntry.decCtxNewDualResponse(); break;
  ...
  public ListResultsResponse decodeListResultsResponse(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(0);
    check(ak.NativeEntry.decodeListResultsResponse(this, decCtx, wireNative, len, dvtListResultsResponse));
    return r;
  }
  ...
  public ListTasksDetailedResponse decodeListTasksDetailedResponse(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(1);
    check(ak.NativeEntry.decodeListTasksDetailedResponse(this, decCtx, wireNative, len, dvtListTasksDetailedResponse));
    return r;
  }
  ...
  public ListProbeResponse decodeListProbeResponse(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(2);
    check(ak.NativeEntry.decodeListProbeResponse(this, decCtx, wireNative, len, dvtListProbeResponse));
    return r;
  }
  ...
  public ListTaskSummaryResponse decodeListTaskSummaryResponse(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(3);
    check(ak.NativeEntry.decodeListTaskSummaryResponse(this, decCtx, wireNative, len, dvtListTaskSummaryResponse));
    return r;
  }
  ...
  public UploadResultDataMessage decodeUploadResultDataMessage(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(4);
    check(ak.NativeEntry.decodeUploadResultDataMessage(this, decCtx, wireNative, len, dvtUploadResultDataMessage));
    return r;
  }
  ...
  public ListMetricsResponse decodeListMetricsResponse(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(5);
    check(ak.NativeEntry.decodeListMetricsResponse(this, decCtx, wireNative, len, dvtListMetricsResponse));
    return r;
  }
  ...
  public DualResponse decodeDualResponse(byte[] wire, int off, int len) {
    ...
    decRoot = r;
    decCtx = decCtxOf(6);
    check(ak.NativeEntry.decodeDualResponse(this, decCtx, wireNative, len, dvtDualResponse));
    return r;
  }
