...
/// WP5 step 10, the no-unknown variant: unknown-field support compiled out. A zero-sized
...
/// Decision 11 rule 6: a decode context BOUND to `Timestamp` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_Timestamp() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(1)
}

/// Decision 11 rule 6: a decode context BOUND to `Duration` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_Duration() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(2)
}

/// Decision 11 rule 6: a decode context BOUND to `ResultRaw` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ResultRaw() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(3)
}

/// Decision 11 rule 6: a decode context BOUND to `TaskOptions` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_TaskOptions() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(4)
}

/// Decision 11 rule 6: a decode context BOUND to `TaskOutput` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_TaskOutput() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(5)
}

/// Decision 11 rule 6: a decode context BOUND to `TaskDetailed` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_TaskDetailed() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(6)
}

/// Decision 11 rule 6: a decode context BOUND to `TaskSummary` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_TaskSummary() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(7)
}

/// Decision 11 rule 6: a decode context BOUND to `Probe` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_Probe() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(8)
}

/// Decision 11 rule 6: a decode context BOUND to `Empty` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_Empty() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(9)
}

/// Decision 11 rule 6: a decode context BOUND to `UploadResultData` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_UploadResultData() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(10)
}

/// Decision 11 rule 6: a decode context BOUND to `MetricsBatch` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_MetricsBatch() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(11)
}

/// Decision 11 rule 6: a decode context BOUND to `Pair` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_Pair() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(12)
}

/// Decision 11 rule 6: a decode context BOUND to `ListResultsResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ListResultsResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(13)
}

/// Decision 11 rule 6: a decode context BOUND to `ListTasksDetailedResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ListTasksDetailedResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(14)
}

/// Decision 11 rule 6: a decode context BOUND to `ListTaskSummaryResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ListTaskSummaryResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(15)
}

/// Decision 11 rule 6: a decode context BOUND to `ListProbeResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ListProbeResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(16)
}

/// Decision 11 rule 6: a decode context BOUND to `ListMetricsResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ListMetricsResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(17)
}

/// Decision 11 rule 6: a decode context BOUND to `UploadResultDataMessage` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_UploadResultDataMessage() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(18)
}

/// Decision 11 rule 6: a decode context BOUND to `DualResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_DualResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(19)
}

/// Decision 11 rule 6: a decode context BOUND to `ChunkLeaf` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ChunkLeaf() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(20)
}

/// Decision 11 rule 6: a decode context BOUND to `ChunkInner` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ChunkInner() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(21)
}

/// Decision 11 rule 6: a decode context BOUND to `ChunkElement` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ChunkElement() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(22)
}

/// Decision 11 rule 6: a decode context BOUND to `ChunkedResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ChunkedResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(23)
}

/// Decision 11 rule 6: a decode context BOUND to `ChunkedResponseWide` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_ChunkedResponseWide() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(24)
}

/// Decision 11 rule 6: a decode context BOUND to `LeafElement` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_LeafElement() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(25)
}

/// Decision 11 rule 6: a decode context BOUND to `LeafResponse` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_LeafResponse() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(26)
}

/// Decision 11 rule 6: a decode context BOUND to `Surrogate` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_Surrogate() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(27)
}

/// Decision 11 rule 6: a decode context BOUND to `SurrogateInner` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_SurrogateInner() -> *mut ak_dec_ctx {
    crate::dec_ctx_alloc(28)
}

/// Decision 11 rule 6: a decode context BOUND to `WireZoo` (no-unknown variant:
/// unknown fields compiled out, no options).
#[no_mangle]
pub unsafe extern "C" fn ak_dec_ctx_new_WireZoo() -> *mut ak_dec_ctx {
