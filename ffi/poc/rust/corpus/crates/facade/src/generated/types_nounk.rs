// @generated by ffi/poc/codec/gen/rust_facade.py (plan from ffi/corpus/corpus.json (reader view) over ffi/schema/shapes.json). Do not edit.


// THE NO-UNKNOWN VARIANT (plan.py; FIX-PLAN R-H22): no `unknown_fields` member.
