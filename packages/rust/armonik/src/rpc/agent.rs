super::service! {
    ...
    rpc CreateResultsMetaData(create_results_metadata::Request) -> create_results_metadata::Response;
    rpc CreateResults(create_results::Request) -> create_results::Response;
    rpc NotifyResultData(notify_result_data::Request) -> notify_result_data::Response;
    rpc SubmitTasks(submit_tasks::Request) -> submit_tasks::Response;
