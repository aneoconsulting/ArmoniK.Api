super::service! {
    ...
    rpc CreateSession(create_session::Request) -> create_session::Response => session_id;
    ...
    rpc ListTasks(list_tasks::Request) -> list_tasks::Response => task_ids;
    rpc ListSessions(list_sessions::Request) -> list_sessions::Response => session_ids;
    ...
    rpc GetTaskStatus(task_status::Request) -> task_status::Response => statuses;
    rpc GetResultStatus(result_status::Request) -> result_status::Response => statuses;
}
