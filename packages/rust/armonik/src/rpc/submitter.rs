super::service! {
    ...
    rpc CountTasks(count_tasks::Request) -> count_tasks::Response;
    rpc TryGetResultStream(try_get_result::Request) -> stream try_get_result::Response;
    rpc TryGetTaskOutput(try_get_task_output::Request) -> try_get_task_output::Response;
    rpc WaitForAvailability(wait_for_availability::Request) -> wait_for_availability::Response;
    rpc WaitForCompletion(wait_for_completion::Request) -> wait_for_completion::Response;
