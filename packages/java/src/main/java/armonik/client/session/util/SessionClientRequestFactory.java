...
/**
 * SessionClientRequestFactory provides static methods for creating gRPC request objects related to session management.
 * It encapsulates the logic for constructing various types of session-related requests, such as creating, retrieving,
 * canceling, pausing, resuming, closing, purging, deleting sessions, and stopping submission for a session.
 */
