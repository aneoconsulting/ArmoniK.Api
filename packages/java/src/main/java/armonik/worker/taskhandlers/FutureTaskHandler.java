...
/**
 * FutureTaskHandler is responsible for handling tasks asynchronously in a gRPC worker.
 * It processes incoming requests and provides methods for interacting with task-related functionalities,
 * such as submitting tasks, creating results, notifying result data, and accessing task information.
 */
public class FutureTaskHandler {
  ...
  /**
   * Constructs a new FutureTaskHandler with the provided process request and gRPC client.
   *
  ...
  /**
   * Submits tasks asynchronously with the provided task creations and task options.
   *
   ...
   */
  public ListenableFuture<SubmitTasksResponse> submitTasks(List<TaskCreation> taskCreations, TaskOptions taskOptions) {
   ...
   * @return A ListenableFuture representing the create results metadata operation.
   */
  public ListenableFuture<CreateResultsMetaDataResponse> createResultsMetaData(List<CreateResultsMetaDataRequest.ResultCreate> resultCreates) {
