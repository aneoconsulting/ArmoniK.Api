...
#include "submitter/ArmonikClient.h"
...
void SubmitterClient::CreateLargeTask(const std::string& session_id,
...
void SubmitterClient::CancelSession(const std::string& session_id)
{
