...
namespace armonik::api::common::serilog
{
  ...
  public:
    ...
    const std::string logger_name; ///< The name of the logger associated with this context.
  private:
    serilog_properties_vector_t _properties; ///< The vector of Serilog properties pairs.
  };
}
